...
Rough hours are fine — half-hours are plenty precise. And if something big in your day doesn't fit those six, name it and we'll add it.`;
  }
...
\`\`\``;
  ...
  // What is CTI doing? — short welcome plus the five-topic menu
  if (topic.topicId === 'what-is-cti-doing') {
    return `**Sensei:** Welcome. \u{1F9ED}

This is a place to explore what CTI is doing, at your own pace. Pick anything from the list, or type your own question.

I'll give you a short answer and then ask what you think — that is how we work.
