...
export function HelpModal({ isOpen, onClose, onStartTour, onOpenStats }: HelpModalProps) {
          ...
          <div className="flex items-center gap-2">
            ...
            {onOpenStats && (
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-emerald-300 hover:text-emerald-200 transition-colors flex items-center gap-2"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
